...
requirements and specific implementation guidelines. The target system 
administrator can use the oscap CLI tool from openscap-scanner
...
-DSSG_PRODUCT_RHEL6:BOOL=OFF \
-DSSG_PRODUCT_RHEL7:BOOL=OFF \
...
%changelog
* Tue Dec 24 2019 Ilya Okomin <ilya.okomin@oracle.com> - 0.1.43-1
